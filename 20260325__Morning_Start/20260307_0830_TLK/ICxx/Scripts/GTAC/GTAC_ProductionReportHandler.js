...
//  Last edit: 20221207 (added in read of model data for tagging part number)
//
//---------------------------------------------------------------------------
    ...
    if (TcHmi.Symbol.readEx("%i%ICxx_Value%/i%") == 1) {
        ...
        TcHmi.Symbol.readEx2(report_symbol, function (data) {
            if (data.error === TcHmi.Errors.NONE) {
                ...
                part_number = TcHmi.Symbol.readEx("%i%" + fixture + "_CurrentModel%/i%"); //Pull in model data selected as part number
