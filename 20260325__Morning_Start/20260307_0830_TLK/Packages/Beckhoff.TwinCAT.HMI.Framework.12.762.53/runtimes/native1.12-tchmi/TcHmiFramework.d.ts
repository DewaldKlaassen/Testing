...
declare namespace TcHmi {
    ...
    class Symbol<ST = any> {
        ...
        isProcessedAsync(): boolean;
        /**
         * When called unwanted destruction of the symbol is avoided by increasing a reference counter.
         * Make sure to call destroy() when you are done with the symbol to decrease the reference counter again and possibly destroy the instance.
         * @preserve (Part of the public API)
         */
        ...
        destroy(): void;
        /**
         * Used to determine if this Symbol instance was already destroyed or not.
         * @preserve (Part of the public API)
         */
        isDestroyed(): boolean;
        /**
    ...
    namespace Symbol {
        ...
        class ObjectResolver<T extends object | null> {
             ...
             * until the controls parent partial (View, Content, UserControl) is initialized to guarantee that symbols of type Control which exist in this scope are available.
             */
            constructor(obj: T, options?: ObjectResolver.IOptions | null);
            /**
...
declare namespace TcHmi.System {
    ...
    interface ControlAttribute {
        ...
        descr: TcHmi.ControlAttributeDescription | null;
    }
...
declare namespace TcHmi.Controls.System {
    ...
    abstract class baseTcHmiControl {
         ...
         * @returns
         */
        protected abstract getAttributeDescription(propertyName: string): ControlAttributeDescription | null;
        /**
...
declare namespace TcHmi.System.Type {
    ...
    namespace Schema {
        class Helper {
            static __resolveSubSchema(schema: TcHmi.JsonSchema, pathTokens: string[] | null, callback?: (this: void, data: TypeManager.ISchemaResultObject) => void): void;
        }
        namespace Helper {
