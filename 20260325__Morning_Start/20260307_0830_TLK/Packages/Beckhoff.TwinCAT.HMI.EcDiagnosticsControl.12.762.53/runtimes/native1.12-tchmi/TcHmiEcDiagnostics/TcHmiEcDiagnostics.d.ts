...
declare namespace EcDiagnostics.FrameworkIncludes {
    namespace TcHmi {
        /**
        ...
        interface IResultObject {
            ...
            details?: TcHmi.Server.IErrorDetails | undefined;
        }
        /**
...
declare namespace EcDiagnostics.Commons {
    type WSTickCallback = (errors: any, data: any, first: boolean) => any;
    type WSCallback = (data: any) => any;
    interface SubscriptionCallback {
        passErrorsToCallback?: boolean;
    ...
    abstract class Communication {
        ...
        abstract subscribe(commands: FrameworkIncludes.TcHmi.Server.ICommand | FrameworkIncludes.TcHmi.Server.ICommand[], interval: number, passErrorsToCallback: boolean, tickCallback: WSTickCallback, initCallback?: WSCallback): number | null;
         ...
         * @template R Type of the read value.Use any (or omit) if this interface contains multiple different types.
         */
        protected processReadValues<W = any, R = any>(subscriptionCallback: SubscriptionCallback, response: FrameworkIncludes.TcHmi.SelectableRequired<FrameworkIncludes.TcHmi.Server.IMessage<W, R>, 'apiVersion' | 'id' | 'sessionId' | 'commands'>): void;
    }
}
declare namespace EcDiagnostics.Commons {
...
declare namespace EcDiagnostics.Commons {
    class Master extends Component {
        ...
        setExtendedInfoTabName(component: 'Master' | 'Slave', tabName: string): void;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiEcDiagnosticsClasses {
    class ControlCommunication extends EcDiagnostics.Commons.Communication {
        ...
        subscribe(commands: TcHmi.Server.ICommand[] | TcHmi.Server.ICommand, interval: number, handleErrorInCallback: boolean, tickCallback: EcDiagnostics.Commons.WSTickCallback, initCallback?: EcDiagnostics.Commons.WSCallback): number | null;
